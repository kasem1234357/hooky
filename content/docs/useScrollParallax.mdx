---
title: useScrollParallax
description: Custom React hook for smooth, interpolated scroll progress parallax effects.
---

import { TypeTable } from 'fumadocs-ui/components/type-table';
import { Tab, Tabs } from 'fumadocs-ui/components/tabs';
import ParallaxExample from '@/examples/ScrollParallaxExample';

# useScrollParallax

A custom React hook designed to provide smooth, interpolated scroll progress values for creating parallax effects. It supports various easing functions and can track either the window scroll or a specific container's scroll position.

## Features

* **Custom Easing**: Choose from built-in functions (`linear`, `easeIn`, `easeOut`, `easeInOut`, `spring`, `bounce`, `elastic`, `anticipate`) or provide a custom easing function.
* **Flexible Tracking**: Supports both global `window` scroll and specific scrollable container elements via `containerRef`.
* **Configurable Physics**: Fine-tune the movement with parameters like `smoothness`, `stiffness`, and `damping`.
* **Directional Control**: Track horizontal, vertical, or both scroll directions.
...
<TypeTable
  type={{
    direction: {
      ...
      description: "Direction to track.",
      default: "'both'",
    },
    smoothness: {
      type: "number",
      description: "Factor for interpolation.",
      default: "0.1",
    },
    stiffness: {
      type: "number",
      description: "Stiffness for spring animations.",
      default: "0.04",
    },
    damping: {
      type: "number",
      description: "Damping for spring animations.",
      default: "0.05",
    },
    easingFunctionName: {
      type: "string",
      description: "The easing algorithm to use.",
      default: "'linear'",
    },
    customEasingFunction: {
      type: "(t: number) => number",
      description: "Custom function for non-standard easing.",
      default: "undefined",
    },
    enabled: {
      type: "boolean",
    ...
    reverseDirection: {
      type: "boolean",
      description: "Inverts the output progress values.",
      default: "true",
    },
    containerRef: {
      type: "React.RefObject<HTMLElement>",
      description: "The specific container to observe.",
      default: "undefined",
    },
  }}
/>
...
The hook returns an object containing the current interpolated progress:

- `smoothScrollXProgress`: The calculated horizontal progress.
- `smoothScrollYProgress`: The calculated vertical progress.
