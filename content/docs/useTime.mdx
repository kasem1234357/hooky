...
| --- | --- | --- |
| getDateinLang |  `(lang?:langShortcut,options:timeOptions = {}) => string` | Get the current date in a specified language and format. | 
| getTimeInLang |  `(lang?:langShortcut,options:timeOptions = {}) => string` | Get the current time in a specified language and format.|
