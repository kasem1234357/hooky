...
const useTime = ()=>{
  const getDateinLang = (lang?:langShortcut,options:timeOptions = {},date:string|Date|null=null)=>{
    return date? new Date(date).toLocaleDateString(lang,options):new Date().toLocaleDateString(lang,options)
  }
const getTimeInLang = (lang?:langShortcut,options:timeOptions = {},date:string|Date|null=null)=>{
    return date? new Date(date).toLocaleTimeString(lang,options):new Date().toLocaleTimeString(lang,options)
}
const getTime =()=>{
    return {
